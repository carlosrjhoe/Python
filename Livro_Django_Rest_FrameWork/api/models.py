...
class FundoImobiliario(models.Model):
    ...
    vacancia_financeir = models.DecimalField(null = False, blank = False, max_digits = 5, decimal_places = 2)
    vacancia_fisica = models.DecimalField(null = False, blank = False, max_digits = 5, decimal_places = 2)
    quantidade_ativo = models.IntegerField(null = False, blank = False, default = 0)
